	...
	<div class="flex flex-col p-5 gap-8 grow">
		...
		<div class="flex flex-col gap-2">
			<div class="flex bg-background rounded-2xl py-4 px-5 gap-5 text-info justify-between items-center dark:bg-background-secondary" style:box-shadow="0px 0px 12px 0px var(--color-shadow)">
				<div class="grow">
					<div class="font-semibold leading-tight mb-1">Tema</div>
			...
			<div class="flex bg-background rounded-2xl py-4 px-5 gap-5 text-info justify-between items-center dark:bg-background-secondary" style:box-shadow="0px 0px 12px 0px var(--color-shadow)">
				<div class="grow">
					<div class="font-semibold leading-tight mb-1">Limitar desbloqueio</div>
			...
			<div class="flex bg-background rounded-2xl py-4 px-5 gap-5 text-info justify-between items-center dark:bg-background-secondary" style:box-shadow="0px 0px 12px 0px var(--color-shadow)">
				<div class="grow">
					<div class="font-semibold leading-tight mb-1">Localização em segundo plano</div>
			...
			<div class="flex bg-background rounded-2xl py-4 px-5 gap-5 text-info justify-between items-center dark:bg-background-secondary" style:box-shadow="0px 0px 12px 0px var(--color-shadow)">
				<div class="grow">
					<div class="font-semibold leading-tight mb-1">Contribuir para estatísticas</div>
			...
			{#if dev}
				<div class="flex bg-background rounded-2xl py-4 px-5 gap-5 text-info justify-between items-center dark:bg-background-secondary" style:box-shadow="0px 0px 12px 0px var(--color-shadow)">
					<div class="grow">
						<div class="font-semibold leading-tight mb-1">Simular desbloqueio</div>
