	...
	<div class="flex flex-col p-5 relative grow overflow-hidden" style:padding-bottom="{Math.max($safeInsets.bottom, 20)}px">
		...
		<div class="flex flex-col h-full px-5 py-10 gap-10 items-center">
			...
			<div class="flex flex-col grow items-center justify-end">
				<a href="https://github.com/rt-evil-inc/gira">
					<svg class="w-12 fill-[#1f2328] dark:fill-[#f0f6fc]" width="120" height="118" viewBox="0 0 120 118" fill="none" xmlns="http://www.w3.org/2000/svg">
