	...
	<div class="flex bg-white rounded-xl py-4 text-info justify-between" style:box-shadow="0px 0px 16px 0px var(--color-shadow)">
		...
		<div class="flex flex-col items-center w-24 justify-between py-2 justify-self-end">
			...
			<div class="flex flex-col items-center">
				...
				<div class="text-primary font-bold text-xs">{trip.bikeName}</div>
			</div>
		</div>
	</div>
{:else}
	<div class="flex bg-neutral-50 rounded-xl py-4 text-info justify-between w-full h-32 animate-pulse " style:box-shadow="0px 0px 16px 0px var(--color-shadow)">
	</div>
{/if}