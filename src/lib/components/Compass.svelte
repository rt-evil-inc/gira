...
{#if bearing !== 0}
	<button on:click transition:fade={{ duration: 150 }} class="bg-background p-2 rounded-full grid grid-cols-1 grid-rows-1 w-12 h-12 active:bg-background" style:box-shadow="0px 0px 20px 0px var(--color-shadow)">
